      ...
      return function() {
        ...
        return function() {
          ...
          e2.default = function(e3, r2, s2 = {}) {
            if ("function" != typeof r2) throw new Error("axios-auth-refresh requires `refreshAuthCall` to be a function that returns a promise.");
            const n2 = { skipInstances: [], refreshCall: void 0, requestQueueInterceptorId: void 0 };
            return e3.interceptors.response.use((e4) => e4, (o) => {
              if (s2 = (0, t2.mergeOptions)(t2.defaultOptions, s2), !(0, t2.shouldInterceptError)(o, s2, e3, n2)) return Promise.reject(o);
